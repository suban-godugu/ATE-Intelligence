  ...
  return (
    <div className="space-y-6 animate-slide-up pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Test Time Breakdown */}
        <div className="bg-[var(--bg-card)] rounded-[var(--radius-lg)] border border-[var(--border)] p-6 shadow-xl flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">2,040ms</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">1,100ms</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">920ms</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
                  <div className="h-full bg-[var(--accent-primary)] rounded-full" style={{ width: '45%' }} />
                </div>
              </div>
              {/* MBIST */}
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">440ms</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">320ms</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
                  <div className="h-full bg-[var(--accent-cyan)] rounded-full" style={{ width: '16%' }} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">{coverage.by_fault_class.stuck_at}%</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">{coverage.by_fault_class.transition}%</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
                  <div className="h-full bg-[var(--accent-cyan)] rounded-full" style={{ width: `${coverage.by_fault_class.transition}%` }} />
                </div>
              </div>
              {/* Cell-aware */}
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">{coverage.by_fault_class.cell_aware}%</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
                  <div className="h-full bg-[var(--accent-primary)] rounded-full" style={{ width: `${coverage.by_fault_class.cell_aware}%` }} />
                </div>
              </div>
              {/* IDDQ */}
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--text-primary)] font-mono font-bold">{coverage.by_fault_class.iddq}%</span>
                </div>
                <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-[var(--accent-primary)]/10 to-transparent rounded-[var(--radius-lg)] border border-[var(--accent-primary)]/20 p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-bold text-[var(--text-primary)]">AI Savings Estimate</h2>
            <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] border border-[var(--accent-primary)]/30">
        ...
        <div className="flex-shrink-0">
          <button 
            ...
            className="w-full md:w-auto px-6 py-3 rounded-xl bg-[var(--accent-primary)] hover:bg-[var(--accent-primary-hover)] text-white font-bold text-sm transition-colors flex items-center justify-center gap-2 shadow-lg"
          >
